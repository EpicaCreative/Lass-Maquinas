...
<form  id="formulario" action="<? $PHP_SELF; ?>" method="POST"> 
  ...
  <center><input type="submit" name="BTEnvia" value="Enviar" style="background-color: #fcc53b; color: white; font-weight: 600; font-family: 'Open Sans', sans-serif; font-size: 18px; padding: 9px 30px; border-radius: 17px; border: none;"></center> 
