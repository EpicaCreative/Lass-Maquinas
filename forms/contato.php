...
if (isset($_POST['BTEnvia'])) {
 ...
 //==================================================== 
 $email_destinatario = "contato@lass.com.br, gustavo@epicacreative.com.br"; // pode ser qualquer email que receberá as mensagens
 $email_reply = "$email"; 
 $email_assunto = "Formulário do site - $form de $nome"; // Este será o assunto da empresa
 //====================================================
 
 //Monta o Corpo da Mensagem
 //====================================================

 $email_conteudo = "$nome está enviando uma mensagem/dúvida \n"; 
 $email_conteudo .= "Telefone de $nome é $telefone \n"; 
 $email_conteudo .= "Email $email \n"; 
 $email_conteudo .= "$nome enviou: $mensagem \n";
...
<body>
   ...
   <div><center><span style="font-family: 'Open Sans', sans-serif; background-color: #08528b; color: white; font-weight: 600; padding-left: 15px; padding-right: 15px; padding-top: 5px; padding-bottom: 5px; line-height: 28px; font-size: 28px;">Entre em contato</span></center></div><br>
 <br>
 ...
 <form  id="formulario" action="<? $PHP_SELF; ?>" method="POST"> 
  ...
  <input type="text" name="telefone_cliente" required="" placeholder="Telefone" class="tipotexto" style="background-color: #ededed; border: none;  height: 9vh; padding-left: 10px; margin-bottom: 3vh;"> 
    ...
    <textarea type="text" name="mensagem" required="" placeholder="Mensagem/Dúvida" class="tipotexto" style="background-color: #ededed; border: none;  height: 20vh; padding-left: 10px; margin-bottom: 3vh; width: 100%;"></textarea> 
