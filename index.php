...
<head>
  ...
  <meta name="author" content="Lass Máquinas">
  <meta property="og:image" itemprop="image" content="https://lass.com.br/meta_logo_lass_maquinas.jpg">
  ...
  <meta name="keywords" content="Lass, máquinas, Tietê, Sorocaba, Piracicaba, Cerquilho, Empilhadeiras, Movimentação, Industrial, Tratores, empresas, maquinario, construção, geradores, aluguel, locação, locacao, alugar, maquina, escavadeira, garantia, pos-venda, venda, comprar, interior, são, paulo, cidade, pecas, peças, pneus, pneu, peca, peça, assistencia, técnica, tecnica, assistencia-tecnica, assistencia-técnica, yanmar, camso, trelleborg, camso-trelleborg, sky-jack, sky-jac, sky, jac, jack, skijec, skijeck, skyjeck, skijec, manitou, manitol, pale, trans, paletrans, pale-trans, xcmg, tudo, em, um, lugar, lass-maquinas, lass-máquinas, tiete, sao"/>
  <meta property="og:url" content="https://lass.com.br">
  <meta content="Lass Máquinas" property="og:title">
  <meta name="description" content="Desde pequenas até grandes empresas a LASS Máquinas tem a solução ideal. Contamos com linha industrial, linha para construção, uma imensa variedade de peças, assistência técnica e um time especializado em pós-venda para te atender.">
  ...
  <link href="images/logolass.png" rel="shortcut icon" type="image/x-icon">
  <link href="images/logolass.png" rel="apple-touch-icon">
  ...
  <div class="section">
   ...
   <div class="section-2">
    <div class="div-block-2-copy-copy">
       <div class="w-row">
        <div class="column w-col w-col-6 w-col-tiny-6"><a href="#movi"><img id="" onclick="movimentacao()" src="images/movimentacao.png" alt="" class="image-7"></a></div>
        <div class="column-2 w-col w-col-6 w-col-tiny-6"><a href="#pecas"><img src="images/Pecas-maquinas.png" onclick="pecas()" alt="" class="image-7"></a></div>
      </div>
      <div class="w-row">
      ...
      <div class="div-block-4"><a href="#locacao"><img src="images/locacaomaq.png" onclick="locar()" alt="" class="image-7-bluebg"></a></div>
    </div>
  </div>
<div class="div-block-2"><a href="#movi"><img onclick="movimentacao()" id="empi" src="images/movimentacao.png" alt="Melhores marcas para a industria adquira ja maquina para fabrica" class="image-7"></a><a href="#const"><img onclick="construcao()" src="images/construction.png" alt="adquira ja maquinas para construcao com a LASS Maquinas onde conseguir maquinario para construcao" class="image-7"></a><a href="#pecas"><img onclick="pecas()" src="images/Pecas-maquinas.png" alt="Compre peças aqui mesmo, contamos com o melhor atendimento da regiao de Tiete" class="image-7"></a><a href="#pneus"><img onclick="pneus()" src="images/Penusmaquinas.png" alt="Compre Pneus Camso em Tietê, Sorocaba e região, Cerquilho, Piracicaba, Camso no interior de São Paulo" class="image-7"></a><a href="#plataformas"><img onclick="plata()" src="images/Plataformas.png" alt="plataformas para industria e demais negocios é aqui emesmo, fabricas no interior de sao paulo, fabricas em Cerquilho, Tietê e regiao" class="image-7"></a><a href="#geradores"><img onclick="gera()" src="images/gerador.png" alt="Gerador da Atlas Copco no interior de São Paulo" class="image-7"></a><a href="#locacao"><img onclick="locar()" src="images/locacaomaq.png" alt="Alugar maquinas para construção, industria e movimentação no interior de São Paulo Tietê, Cerquilho, Sorocaba, Piracicaba e Região Locaçao de maquinas" class="image-7-bluebg"></a></div>
 ...
 <div class="mov" id="movi">
    ...
    <div class="w-row">
      ...
      <div class="w-col w-col-6">
        ...
        <div class="html-embed-contact-form w-embed"><iframe scrolling="no" style="height: 50vh; width: 80%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquina.php?maquina=<?php echo "maquinademovimentacao" ?>&utm_source=<? echo $origem; ?>"></iframe></div>
      </div>
    </div>
  </div>
  <div class="construction" style="display: none;" id="const">
    ...
    <div class="w-row">
      ...
      <div class="w-col w-col-6">
        <h1 class="heading-copyyy-copy" style="margin-bottom: 0px;">Solicite contato comercial</h1><a href="#" onclick="fechar()" style="text-decoration: none;"><h1 class="fechar-2" style="margin-bottom: 30px;">fechar</h1></a>
        <div class="html-embed-contact-form w-embed"><iframe scrolling="no" style="height: 50vh; width: 80%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquina.php?maquina=<?php echo "maquinadeconstrucao"; ?>&utm_source=<? echo $origem; ?>" id="form-ask"></iframe></div>
      </div>
    </div>
  </div>
  <div class="parts" style="display: none;" id="pecas">
    ...
    <div class="w-row">
      ...
      <div class="w-col w-col-6">
        <h1 class="heading-copyyy-copy" style="margin-bottom: 0px;">Solicite contato comercial</h1><a href="#" onclick="fechar()" style="text-decoration: none;"><h1 class="fechar-2" style="margin-bottom: 30px;">fechar</h1></a>
        <div class="html-embed-contact-form w-embed"><iframe scrolling="no" style="height: 50vh; width: 80%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquina.php?maquina=<?php echo "pecas"; ?>&utm_source=<? echo $origem; ?>" id="form-ask"></iframe></div>
      </div>
    </div>
  </div>
  <div class="pneus" style="display: none;" id="pneus">
    ...
    <div class="w-row">
      ...
      <div class="w-col w-col-6">
        <h1 class="heading-copyyy-copy" style="margin-bottom: 0px;">Solicite contato comercial</h1><a href="#" onclick="fechar()" style="text-decoration: none;"><h1 class="fechar-2" style="margin-bottom: 30px;">fechar</h1></a>
        <div class="html-embed-contact-form w-embed"><iframe scrolling="no" style="height: 50vh; width: 80%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquina.php?maquina=<?php echo "pneus"; ?>&utm_source=<? echo $origem; ?>" id="form-ask"></iframe></div>
      </div>
    </div>
  </div>
  <div class="plataformas" style="display: none;" id="plataformas">
    ...
    <div class="w-row">
      ...
      <div class="w-col w-col-6">
        <h1 class="heading-copyyy-copy" style="margin-bottom: 0px;">Solicite contato comercial</h1><a href="#" onclick="fechar()" style="text-decoration: none;"><h1 class="fechar-2" style="margin-bottom: 30px;">fechar</h1></a>
        <div class="html-embed-contact-form w-embed"><iframe scrolling="no" style="height: 50vh; width: 80%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquina.php?maquina=<?php echo "plataformas"; ?>&utm_source=<? echo $origem; ?>" id="form-ask"></iframe></div>
      </div>
    </div>
  </div>
  <div class="geradores" style="display: none;" id="geradores">
    ...
    <div class="w-row">
      ...
      <div class="w-col w-col-6">
        <h1 class="heading-copyyy-copy" style="margin-bottom: 0px;">Solicite contato comercial</h1><a href="#" onclick="fechar()" style="text-decoration: none;"><h1 class="fechar-2" style="margin-bottom: 30px;">fechar</h1></a>
        <div class="html-embed-contact-form w-embed"><iframe scrolling="no" style="height: 50vh; width: 80%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquina.php?maquina=<?php echo "geradores"; ?>&utm_source=<? echo $origem; ?>" id="form-ask"></iframe></div>
      </div>
    </div>
  </div>
  <div class="locacao" style="display: none;" id="locacao">
    ...
    <div class="w-row">
      ...
      <div class="w-col w-col-6">
        <h1 class="heading-copyyy-copy" style="margin-bottom: 0px;">Solicite contato comercial</h1><a href="#" onclick="fechar()" style="text-decoration: none;"><h1 class="fechar-2" style="margin-bottom: 30px;">fechar</h1></a>
        <div class="html-embed-contact-form w-embed"><iframe scrolling="no" style="height: 50vh; width: 75%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/locacao.php?utm_source=<? echo $origem; ?>" id="form-ask"></iframe></div>
      </div>
    </div>
  </div>
  ...
  <div class="div-block-9-copy"><img src="images/aluguel-de-maquinas-construcao-mobile.jpg" srcset="images/aluguel-de-maquinas-construcao-mobile-p-500.jpeg 500w, images/aluguel-de-maquinas-construcao-mobile-p-800.jpeg 800w, images/aluguel-de-maquinas-construcao-mobile.jpg 846w" sizes="(max-width: 479px) 90vw, 100vw" alt="">
      <div class="div-block-7-copy" id="conshidemob" style="display: block;">
        <div class="div-block-8">
          ...
          <p class="paragraph">Desde pequenas até grandes empresas a LASS Máquinas tem a solução ideal como Miniescavadeiras, Carregadeiras, geradores, entre outros.</p>
      ...
      <div class="construction-solicite-mobile" id="consshowmob" style="height: 400px; display: none;">
        <div class="div-block-8">
          ...
          <div class="html-embed-2 w-embed"><iframe scrolling="no" style="height: 380px; overflow:hidden; width: 102%;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquina.php?maquina=<?php echo "maquina de construcao"; ?>&utm_source=<? echo $origem; ?>"></iframe></div>
        </div>
      </div>
    </div>
    <div class="div-block-9-copy"><img src="images/aluguel-de-maquinas-plataforma-empilhadeiras.jpg" srcset="images/aluguel-de-maquinas-plataforma-empilhadeiras-p-500.jpeg 500w, images/aluguel-de-maquinas-plataforma-empilhadeiras-p-800.jpeg 800w, images/aluguel-de-maquinas-plataforma-empilhadeiras.jpg 846w" sizes="(max-width: 479px) 90vw, 100vw" alt="">
      ...
      <div class="industrial-solicite-mobile" id="indshowmob" style="height: 400px; display: none;">
        <div class="div-block-8">
          ...
          <div class="html-embed-2 w-embed"><iframe scrolling="no" style="height: 380px; overflow:hidden; width: 102%;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquinayellow.php?maquina=<?php echo "maquina de industrial"; ?>&utm_source=<? echo $origem; ?>"></iframe></div>
        </div>
      </div>
    </div>
    ...
    <div class="construction-solicite" id="consshowdesk">
      <div class="div-block-6-copy-copy">
        ...
        <div class="html-embed-2 w-embed"><iframe scrolling="no" style="height: 380px; width: 100%; overflow:hidden; width: 95%;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquina.php?maquina=<?php echo "maquina de construcao"; ?>&utm_source=<? echo $origem; ?>"></iframe></div>
      </div>
    </div>
  </div>
  <div class="section-4">
    ...
    <div class="industrial-solicite" id="indshowdesk">
      <div class="div-block-6-copyyyy">
        ...
        <div class="html-embed-2 w-embed"><iframe scrolling="no" style="height: 380px; width: 100%; overflow:hidden; width: 95%;" frameborder="0" src="https://www.epicacreative.com.br/lass/maquinayellow.php?maquina=<?php echo "maquina de industrial"; ?>&utm_source=<? echo $origem; ?>"></iframe></div>
      </div>
    </div>
  </div>
  ...
  <div class="section-6" id="locar">
    <div class="div-block-10"><img src="images/empilhadeira-da-yanmar-para-alugar.png" srcset="images/empilhadeira-da-yanmar-para-alugar-p-500.png 500w, images/empilhadeira-da-yanmar-para-alugar-p-800.png 800w, images/empilhadeira-da-yanmar-para-alugar.png 846w" sizes="(max-width: 479px) 90vw, 100vw" alt="">
      ...
      <div class="loca-solicite-mobile" id="locarshowmobone" style="display:none; width: 90%">
        ...
        <div class="html-embed-2 w-embed"><iframe scrolling="no" style="height: 420px; width: 100%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/locacao.php?utm_source=<? echo $origem; ?>"></iframe></div>
      </div>
    </div>
    <div class="columns-2 w-row" id="locar-maquina">
      <div class="column-4-copy-copy w-col w-col-6 w-col-small-6" id="colunaloca">
        ...
        <div class="locar-solicite" id="locar_solicite">
          ...
          <div class="html-embed-2 w-embed"><iframe scrolling="no" style="height: 380px; width: 100%; overflow:hidden; width: 95%;" frameborder="0" src="https://www.epicacreative.com.br/lass/locacao.php?utm_source=<? echo $origem; ?>"></iframe></div>
        </div>
      </div>
  ...
  <div class="section-6-copy-copy" id="comprar-pecas">
    <div class="div-block-10"><img src="images/compre-peças-de-maquinarios.jpg" srcset="images/compre-peças-de-maquinarios-p-500.jpeg 500w, images/compre-peças-de-maquinarios-p-800.jpeg 800w, images/compre-peças-de-maquinarios.jpg 846w" sizes="(max-width: 479px) 90vw, 100vw" alt="">
      ...
      <div class="pecas-solicite-mobile" id="pecasshowmob" style="display: none; height: 320px; width: 90%">
        ...
        <div class="html-embed-2 w-embed"><iframe scrolling="no" style="height: 380px; width: 100%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/compras.php?maquina=<?php echo "pecas"; ?>&utm_source=<? echo $origem; ?>"></iframe></div>
      </div>
    </div>
  ...
  <div class="section-6-copy">
    <div class="div-block-10"><img src="images/pneus-da-camso-para-comprar.jpg" srcset="images/pneus-da-camso-para-comprar-p-500.jpeg 500w, images/pneus-da-camso-para-comprar-p-800.jpeg 800w, images/pneus-da-camso-para-comprar.jpg 846w" sizes="(max-width: 479px) 90vw, 100vw" alt="">
      ...
      <div class="pneus-solicite-mobile" id="pneusshowmob" style="display: none; height: 380px; width: 90%">
        ...
        <div class="html-embed-2 w-embed"><iframe scrolling="no" style="height: 380px; width: 100%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/compras.php?maquina=<?php echo "pneus"; ?>&utm_source=<? echo $origem; ?>"></iframe></div>
      </div>
    </div>
    ...
    <div class="columns-4 w-row">
      <div class="w-col w-col-6">
        <div id="assistshowdesk" style="display: none;">
          ...
          <div class="html-embed-contact-form-copy w-embed"><iframe scrolling="no" style="height: 50vh; width: 80%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/assistencia-pos.php?maquina=<?php echo "AssistenciaTecnica"; ?>&utm_source=<? echo $origem; ?>" id="form-ask"></iframe></div>
        </div>
      </div>
      <div class="w-col w-col-6">
        <div id="pvshowdesk" style="display: none;">
          ...
          <div class="html-embed-contact-form w-embed"><iframe scrolling="no" style="height: 50vh; width: 80%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/assistencia-pos.php?maquina=<?php echo "PosVenda"; ?>&utm_source=<? echo $origem; ?>" id="form-ask"></iframe></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section-9" id="entrar-em-contato">
    <div class="w-row">
      ...
      <div class="column-13 w-col w-col-6">
        <div class="html-embed-contact-form w-embed"><iframe scrolling="no" style="height: 50vh; width: 100%; overflow:hidden;" frameborder="0" src="https://www.epicacreative.com.br/lass/contato.php?utm_source=<? echo $origem; ?>"></iframe></div>
    ...
    <div class="w-row">
      ...
      <div class="column-16 w-col w-col-3">
        <div>
          ...
          <p class="paragraph-5"><a href="tel:153389-1010" class="paragraph-5" style="text-decoration: none;">(15) 3389-1010</a> |  <a href="tel:153282-5109" class="paragraph-5" style="text-decoration: none;">(15) 3282-5109</a></p>
      ...
      <div class="w-col w-col-3">
        ...
        </div><a target="_blank" href="https://www.instagram.com/lassmaquinas/" ><img src="images/maquinas-empilhadeiras-industriais-construcao-movimentacao.png" width="16" alt="" class="image-11" style="width: 30px;"></a><a href="https://www.facebook.com/lassmaquinas/"  target="_blank"><img src="images/aluguel-de-maquinas-compras-de-pecas.png" width="16" alt="" style="width: 30px; margin-left: 5px;"></a></div>
    </div>
  </div>
  <div class="section-12">
    <a href="https://www.epicacreative.com.br/" target="_blank" style="text-decoration: none;"><p class="paragraph-6">Desenvolvido por Épica Creative</p></a>
  </div>
